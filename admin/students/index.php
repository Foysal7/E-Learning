                                    ...
                                    <tbody>
                                        ...
                                        while($row=mysqli_fetch_array($run)){
                                           ...
                                           <?php
                                            ...
                                            <li><a href="view.php?user_Id='.$row["user_Id"].'"><span class="glyphicon glyphicon-edit"></span> View</a></li>
                                            <li><a href="edit.php?user_Id='.$row["user_Id"].'"><span class="glyphicon glyphicon-edit"></span> Edit</a></li>
                                            <li><a href="#"  user_Id="'.$row['user_Id'].'" class="delbutton" title="Click To Delete"><span class="glyphicon glyphicon-trash"></span> Delete</a></li>
                                            </ul>
                                            </div>'
                                                    ."</td>";
