                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                   <div class="table-toolbar">
                                      <div class="btn-group">
                                         <a href="add-cat.php"><button class="btn btn-success">Add New <i class="icon-plus icon-white"></i></button></a>
                                      </div>
                                    ...
                                    <tbody>
                                        ...
                                        while($row=mysqli_fetch_array($run)){
                                            ...
                                            <li><a href="edit.php?cat_Id='.$row["cat_Id"].'"><span class="glyphicon glyphicon-edit"></span> Edit</a></li>
                                            <li><a href="#"  cat_Id="'.$row['cat_Id'].'" class="delbutton" title="Click To Delete"><span class="glyphicon glyphicon-trash"></span> Delete</a></li>
                                            </ul>
                                            </div>'
                                                    ."</td>";
