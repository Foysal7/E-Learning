...
<html lang="en">
 <head>
  ...
  <body>
    ...
    <br>
<marquee style="font-size: 20px; font-family: sans-serif;color: #8ebf42; padding: 10px 0; background-color: black; font-weight: 800;">Welcome To CSS Tutorial</marquee><br>
