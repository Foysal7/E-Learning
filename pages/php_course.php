      ...
      <div class="container">
        ...
        <nav>
          <ul>
            ...
            <li class="current"><a href="php_course.php">PHP</a></li>
...
<marquee style="font-size: 20px; font-family: sans-serif;color: #8ebf42; padding: 10px 0; background-color: black; font-weight: 800;">Welcome To PHP Tutorial</marquee><br>
...
$sql = mysqli_query($con,"SELECT * FROM `tbl_post` WHERE cat_name='PHP'");
