                ...
                <div class="span3" id="sidebar">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                        ...
                        <?php
                                    ...
                                    ?>
                            <a href="post/index.php"><span class="badge badge-info pull-right"><?php echo $percent;?></span> Post</a>
                        </li>
                        <!--
                         <li>
                        <?php
                             ...
                             <!-- <?php
                                ...
                                <div class="span3">
                                 <?php
                                    ...
                                    ?>
                                    <div class="chart" data-percent="53"><?php echo $percent;?></div>
                                    <div class="chart-bottom-heading"><span class="label label-info">Post</span>
                            ...
                            <div class="block">
                                <div class="navbar navbar-inner block-header">
                                 <?php
                                    ...
                                    ?>
                                    <div class="muted pull-left">Post</div>
                                    <div class="pull-right"><span class="badge badge-info"><?php echo $percent;?></span>
                                ...
                                <div class="block-content collapse in">
                                    ...
                                    <tbody>
                                        ...
                                        while($row=mysqli_fetch_array($run)){
                                            ...
                                            <ul class="dropdown-menu pull-right" role="menu">
                                            <li><a href="post/index.php"><span class="glyphicon glyphicon-edit"></span> View</a></li>
