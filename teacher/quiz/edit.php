                ...
                <div class="span3" id="sidebar">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                        ...
                        <?php
                                    ...
                                    $result=mysqli_query($con,"SELECT count(*) as total from tbl_post");
                                    $data=mysqli_fetch_assoc($result);
                                    $percent = $data['total'];
                                    
                                    ?>
                            <a href="../post/index.php"><span class="badge badge-success pull-right"><?php echo $percent;?></span> Post</a>
                        </li>
                        <!--
                          <li>
                        <?php
                     ...
                     <div class="span12">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Edit Quiz</div>
                            </div>
                            <?php
             ...
             $id = $_GET['quiz_Id'];
                ...
                ?>
                            ...
                            <!-- block -->
                             ...
                             <div class="block-content collapse in">
                                   <textarea id="ckeditor_full" name="question_name">
                                       <?php echo $a;?>
                                   </textarea>
                                </div>

                                <label>Choices</label>
                                <input type="text" class="form-control" name="answer1" value="<?php echo $b;?>" placeholder="answer1"><br>
                                <input type="text" class="form-control" name="answer2" value= "<?php echo $c;?>" placeholder="answer2"><br>
                                <input type="text" class="form-control" name="answer3" value= "<?php echo $d;?>" placeholder="answer3"><br>
                                <input type="text" class="form-control" name="answer4" value= "<?php echo $e;?>" placeholder="answer4"><br>
                                <label>Correct Answer</label>
                                <input type="text" class="form-control" name="answer" placeholder="correct answer" value= "<?php echo $f;?>">
                            <!-- /block -->
