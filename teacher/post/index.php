        ...
        <div class="navbar navbar-fixed-top">
            <div class="navbar-inner">
                <div class="container-fluid">
                    ...
                    <a class="brand" href="#">Teacher Panel</a>
                    ...
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                     ...
                     -->
                        ...
                        <?php
                                    ...
                                    ?>
                            <a href="index.php"><span class="badge badge-info pull-right"><?php echo $percent;?></span> Post</a>
                        </li>
                    </ul>
                </div>
                   ...
                   <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">List of Post</div>
                                   ...
                                   <div class="table-toolbar">
                                    ...
                                    <tbody>
                                        ...
                                        while($row=mysqli_fetch_array($run)){
                                            ...
                                            <li><a href="edit.php?post_Id='.$row["post_Id"].'"><span class="glyphicon glyphicon-edit"></span> Edit</a></li>
                                            <li><a href="#"  post_Id="'.$row['post_Id'].'" class="delbutton" title="Click To Delete"><span class="glyphicon glyphicon-trash"></span> Delete</a></li>
                                            </ul>
                                            </div>'
                                                    ."</td>";
...
var del_id = element.attr("topic_Id");

//Built a url to send
var info = 'topic_Id=' + del_id;
