    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            $sql = "SELECT * FROM `tbl_category`";
                ...
                <br>
                 <input type="submit" name="abc" class="btn btn-primary" value="Publish">
                </form>
            ...
            if(isset($_GET['post_Id'])){
             $id = $_GET['post_Id'];
                ...
                if(isset($edit))
                {
                    ...
                    $sql = "UPDATE `tbl_post` SET `title`='$title',`content`='$content',`datetime_posted`='$datetime',`cat_name`='category' WHERE `post_Id`='$id'";
                    $run = mysqli_query($con,$sql);
